...
### 1. STRIPE_SETUP_GUIDE_V3.pdf (54 KB)
...
### 2. UPDATED_DOCS_FOR_NEW_CONVERSATION_V3.pdf (55 KB)
...
### 3. JNX_OS_MASTER_DOC_V3_COMPACT.pdf (47 KB)
**Purpose**: Complete system reference (compact version)
...
3. `/home/ubuntu/jnx-os/JNX_OS_MASTER_DOC_V3_COMPACT.pdf`
...
1. Keep `JNX_OS_MASTER_DOC_V3_COMPACT.pdf` handy
...
```
d3220d4 - Docs: Added compact master documentation PDF
32136d9 - Docs: Only keep PDF versions (V3)
