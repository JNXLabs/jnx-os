-- ═══════════════════════════════════════════════════════════════════════
-- JNX-OS: SAFE Migration from Schema v1 to v2 (Clerk Integration)
-- ═══════════════════════════════════════════════════════════════════════
-- CRITICAL: Run this in Supabase SQL Editor with NO active connections
-- This migration is IDEMPOTENT and safe to run multiple times
-- ═══════════════════════════════════════════════════════════════════════

-- STEP 0: Disable realtime to prevent conflicts
ALTER PUBLICATION supabase_realtime DROP TABLE IF EXISTS users;
ALTER PUBLICATION supabase_realtime DROP TABLE IF EXISTS orgs;
...
-- Add deleted_at column (CRITICAL: This is what was failing)
ALTER TABLE users 
